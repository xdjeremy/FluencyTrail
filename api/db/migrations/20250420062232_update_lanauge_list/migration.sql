...
UPDATE "Language" SET "nativeName" = 'English', "code" = 'gb' WHERE "name" = 'English';
...
UPDATE "Language" SET "nativeName" = '日本語', "code" = 'jp' WHERE "name" = 'Japanese';
UPDATE "Language" SET "nativeName" = '한국어', "code" = 'kr' WHERE "name" = 'Korean';
UPDATE "Language" SET "nativeName" = '中文', "code" = 'cn' WHERE "name" = 'Chinese'; -- Note: 'zh' covers multiple variants, using the general code.
